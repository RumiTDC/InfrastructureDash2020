CREATE TABLE [edw].[Dim_Adresse] (
    ...
    [dw_DateCreated]                DATETIME         CONSTRAINT [DF__Dim_Adres__dw_Da__2116E6DF] DEFAULT (getdate()) NULL,
    [dw_DateModified]               DATETIME         NULL,
    [dw_LogID]                      BIGINT           NULL,
    [dw_LogDetailID]                BIGINT           NULL,
    CONSTRAINT [PK_edw_Dim_Adresse] PRIMARY KEY CLUSTERED ([Adresse_Key] ASC) WITH (FILLFACTOR = 90)
);
