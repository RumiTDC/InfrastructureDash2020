CREATE TABLE [dm].[InfrastructureBaseDataV2] (
    ...
    [CreateLogDatetime]                DATETIME2 (7) CONSTRAINT [InfrastructureBaseDataV2_CreateLogDatetime_DF] DEFAULT (getdate()) NOT NULL,
    [ChangedDatetime]                  DATETIME      CONSTRAINT [InfrastructureBaseDataV2_ChangedDatetime_DF] DEFAULT (getdate()) NOT NULL,
    [ValidFromDatetime]                DATETIME      CONSTRAINT [InfrastructureBaseDataV2_ValidFromDatetime_DF] DEFAULT (format(getdate(),'yyyy-MM-01 00:00:00')) NOT NULL,
    [ValidToDatetime]                  DATETIME      NULL,
    [IsCurrent]                        BIT           CONSTRAINT [InfrastructureBaseDataV2_IsCurrent_DF] DEFAULT ((1)) NULL,
    [IsDeleted]                        BIT           CONSTRAINT [InfrastructureBaseDataV2_IsDeleted_DF] DEFAULT ((0)) NULL
);


GO
CREATE CLUSTERED INDEX [InfrastructureBaseDataV2_ClusteredIndex]
    ON [dm].[InfrastructureBaseDataV2]([Adresse_Kvhx] ASC, [IsCurrent] ASC, [IsDeleted] ASC) WITH (FILLFACTOR = 90);
