...
CREATE procedure [inf].[Dim_Teknologi] AS


IF OBJECT_ID('tempdb.dbo.#TEK_STEP1', 'U') IS NOT NULL   DROP TABLE #TEK_STEP1; 
IF OBJECT_ID('tempdb.dbo.#TEK_STEP2', 'U') IS NOT NULL   DROP TABLE #TEK_STEP2; 
IF OBJECT_ID('tempdb.dbo.#TEK_STEP3', 'U') IS NOT NULL   DROP TABLE #TEK_STEP3; 
IF OBJECT_ID('tempdb.dbo.#TEK_STEP4', 'U') IS NOT NULL   DROP TABLE #TEK_STEP4; 
...
TRUNCATE TABLE	[stg].[Teknologi_Inf]
Insert into		[stg].[Teknologi_Inf]
...
IF OBJECT_ID('tempdb.dbo.#TEK_STEP1', 'U') IS NOT NULL   DROP TABLE #TEK_STEP2; --Drop temptable to relieve TEMPDB
IF OBJECT_ID('tempdb.dbo.#TEK_STEP1', 'U') IS NOT NULL   DROP TABLE #TEK_STEP3; --Drop temptable to relieve TEMPDB
IF OBJECT_ID('tempdb.dbo.#TEK_STEP1', 'U') IS NOT NULL   DROP TABLE #TEK_STEP4; --Drop temptable to relieve TEMPDB