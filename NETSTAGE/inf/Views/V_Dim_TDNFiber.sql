...
CREATE VIEW [inf].[V_Dim_TDNFiber] AS

SELECT  BK_TDNFiber = [KVHX]
, [TDN_Antenneforeningen_Vejen] = CAST([TDN_Antenneforeningen_Vejen] as int)			-- Ikke Konkurrerende PDS
      ...
      ,[TDN_It_Lauget_Parknet] = CAST([TDN_It_Lauget_Parknet] as int)					-- Ikke konkurrerende PDS
