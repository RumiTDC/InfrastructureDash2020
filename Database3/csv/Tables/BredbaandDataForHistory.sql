CREATE TABLE [csv].[BredbaandDataForHistory] (
    ...
    [HistoryLogID]                     BIGINT        NOT NULL,
    [HistoryValidDateTimeFrom]         DATETIME2 (7) NULL,
    [HistoryValidDateTimeTo]           DATETIME2 (7) NULL,
    [HistoryModifiedLogID]             BIGINT        NULL,
    [HistoryModifiedDate]              DATETIME2 (7) NULL,
    [HistoryCurrentRec]                BIT           NULL,
    [HistoryDeletedAtSource]           BIT           NULL,
    CONSTRAINT [PK_BredbaandDataForHistory] PRIMARY KEY CLUSTERED ([Adresse_Kvhx] ASC, [HistoryLogID] ASC) WITH (FILLFACTOR = 90)
);
